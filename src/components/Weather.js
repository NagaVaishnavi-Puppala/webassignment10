...
class Weather extends Component {
    ...
    getWeatherData = () => {
        axios.get(`http://api.openweathermap.org/data/2.5/forecast?q=${this.state.city}&appid=d96ba3b096a9623e3a17565f50222e65`)
            .then(res => {
                console.log(res);
                    ...
                    <div className="SearchBarChilds">
                        ...
                        <form onSubmit={this.searchCity}>
                            <TextField
                                ...
                                type="text" values ={this.state.value} onChange={this.handleChange} name="city" id="inputSearchCity" placeholder="Search City..."
                                InputLabelProps={{
                                    shrink: true,
                                }}
